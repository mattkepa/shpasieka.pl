...
<body>
    ...
    <div class="slideout-widget-container d-none d-md-flex flex-column">
        ...
        <a href="../../222ldw/" class="widget-item d-flex align-items-center">
            <img src="../../assets/hexagons_teams/hexagon_222ldw.svg" alt="Czarny sześciokąt z logiem II ŁDH-rzy">
            <div class="widget-item-text">222 ŁDW "Rój"</div>
        </a>
    ...
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="../">Aktualności</a></li>
        </ol>
    </div>
    <!-- BREADCRUMBS END -->
    ...
    <main>
        <div class="container">
            <div class="row news-container">
                <?php
                    $result = $sql->query("SELECT * FROM news WHERE archive='".$_GET['date']."' ORDER BY id DESC");
                ...
                <div class="row">
                    <div class="sites-links col-md-5 d-flex flex-column">
                        ...
                        <div class="teams-sites-links d-flex flex-column">
                            ...
                            <a href="../../222ldw/" class="team-site-link d-flex align-items-center mt-3" target="_blank">
                                <img src="../../assets/logotypes_teams/222ldw_logo_white.svg" alt="#">
                                <span class="team-name ml-3">222 ŁDW "Rój"</span>
                            </a> <!-- /.team-site-link -->
