<?php
    require_once("news/dbconnect.php");
?>
...
<body>
                        ...
                        $news .= '<div class="news-card col-md-6 col-lg-4 mb-30">';
                            $news .= '<a href="news-id='.$rekord["id"].'/">';
                                $news .= '<div class="entry-img">';
                                    $news .= '<img src="../assets/news/'.$rekord["photo_small_name"].'" class="img-fluid" alt="Alternative text">';
    ...
    <script src="../js/masonry-news.js"></script>
</body>
</html>