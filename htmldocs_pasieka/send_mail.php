<?php
    ...
    if(isset($_POST['submit'])) {
        ...
        if($isValid) {
            ...
            //Content
            $mail->Subject = 'Nowa wiadomość od: '.$fromName.' <'.$fromEmail.'> ze strony shpasieka.org';
            $mail->Body    = $message;
            $mail->AltBody = $message;

            if($mail->send()) {
                $sendSuccessMsg = 'Wiadomość została pomyślnie wysłana.';
            } else {
                $sendErrorMsg = 'Wiadomość nie mogła zostać wysłana.<br/>'.$mail->ErrorInfo;
            }
        }
    }
    ?>
...
<body>
    ...
    <div class="slideout-widget-container d-none d-md-flex flex-column">
        ...
        <a href="../../22ldh/" class="widget-item d-flex align-items-center">
            <img src="../../assets/hexagons_teams/hexagon_22ldh.svg" alt="Czarny sześciokąt z logiem 22 ŁDH-ek">
            <div class="widget-item-text">22 ŁDH-ek "Watra"</div>
        </a>
        <a href="../../zuchy/" class="widget-item d-flex align-items-center">
            <img src="../../assets/hexagons_teams/hexagon_lgzpp.svg" alt="Czarny sześciokąt z logiem ŁGZ Pracowite Pszczółki">
        ...
        <div class="container">
            <div class="row">
                <section class="col-md-6 meeting-place-info mb-20">
                    <h2 class="text-uppercase">Harcówka</h2>
                    <p>
                        ul. Żubardzka 3
                        <br>
                        91-022 Łódź
                    ...
                    <p>
                        Pawilon, I piętro, ściana południowa (wejście od KSERO).
                    </p>

                    <h3 class="text-uppercase">Zbiórki harcerek i harcerzy</h3>
                    <p>
                        Zbiórki 22 ŁDH-ek odbywają się co drugi tydzień w <span class="meeting-info">PIĄTKI&nbsp;o&nbsp;godz.&nbsp;17:30</span>.
                        <br>
                        Dodatkowo w tygodniach, w których nie ma zbiórki drużyny, odbywają się zbiórki zastępów w terminach ustalonych przez zastępy.
                        <br><br>
                        Zbiórki II ŁDH-rzy odbywają się w <span class="meeting-info">CZWARTKI&nbsp;o&nbsp;godz.&nbsp;17:30</span>.
                        <br>
                        Dodatkowo raz w miesiącu odbywa się zbiórka zastępu starszoharcerskiego.
                        <br><br>
                        Miejscem zbiórek drużyn harcerskich jest <span class="meeting-info">HARCÓWKA</span>.
                        <br>
                        Jeżeli miejsce spotkania będzie inne, taka informacja pojawi się na stronie.
                    </p>
                </section>

                <section class="col-md-6 meeting-place-info mb-20">
                    <h2 class="text-uppercase">Szkoła Podstawowa nr 56</h2>
                    <p>
                        ul. Turoszowska 10
                        <br>
                        91-025 Łódź
                    ...
                    <h3 class="text-uppercase">Zbiórki zuchów</h3>
                    <p>
                        Zbiórki ŁGZ "Pracowite Pszczółki" odbywają się w każdy <span class="meeting-info">PIĄTEK&nbsp;o&nbsp;godz.&nbsp;17:30</span>.
                        <br>
                        Miejscem zbiórek jest <span class="meeting-info">SZKOŁA PODSTAWOWA nr 56</span>.
                    </p>
                </section>
            </div>
            ...
            <section id="komenda mb-30">
                ...
                <div class="row">
                    <div class="business-card col-lg-6 d-flex flex-column">
                        ...
                        <div class="business-card-content">
                            <div class="person-info">
                                <div class="name">pwd. Marta Koślaga HO</div>
                    ...
                    <div class="business-card col-lg-6 d-flex flex-column">
                        ...
                        <div class="business-card-content">
                            <div class="person-info">
                                <div class="name">ćw. Mateusz Kęoa</div>
            ...
            <div class="row">
                <section class="col-lg-6">
                    <h2 class="text-uppercase">Przejdź do kontaktu z jednostkami</h2>
                    ...
                    <form method="post">
                        ...
                        <div class="form-group form-check">
                            ...
                            <label id="rodo-label" class="form-check-label" for="rodo-check">
                                <small>
                                    Zapoznałam/em się z
                                    <span class="d-inline-block" tabindex="0" data-toggle="tooltip" data-placement="top" data-trigger="click" data-html="true" data-container="body" data-title="<p>Wyrażam zgodę na przetwarzanie moich danych osobowych zgodnie z ustawą o ochronie danych osobowych w celach wyłącznie kontaktowych.</p><p>Administratorem Twoich danych osobowych jest komenda Szczepu Harcerskiego Pasieka (ul. Żubardzka 3, 91-022 Łódź). Podanie danych osobowych jest dobrowolne, jednak niezbędne do utrzymania korenspondencji mailowej. Zostałam/em poinformowana/y, że przysługuje mi prawo dostępu do swoich danych, możliwości ich poprawienia oraz żądania zaprzestania ich przetwarzania.</p>">
                                            <a href="#" style="pointer-events: none;" disabled>informacją o administratorze i przetwarzaniu danych</a>
                                    </span>
                                </small>
                            </label>
                        </div>
                        ...
                        <button type="submit" class="btn bg-black my-3" name="submit">Wyślij</button>
                        ...
                        <?php
                            if($isValid) {
                                ...
                                echo '<div class="alert alert-danger alert-custom-invalid"><i class="fa fa-exclamation-triangle mr-2" aria-hidden="true"></i>Wiadomość nie została wysłana.<br/>Przynajmniej jedno pole zostało błędnie wypełnione.</div>';
                            }
                        ?>
